...
export class Level01 {
  ...
  build() {
    ...
    this.transformPads = [new TransformPad(this.scene,{x:-2.2,y:.56,z:6.1},'wood'),new TransformPad(this.scene,{x:-2.2,y:.56,z:8.8},'stone'),new TransformPad(this.scene,{x:2.2,y:.56,z:8.8},'paper')];
