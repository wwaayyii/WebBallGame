...
export class Level01 {
  ...
  build() {
    ...
    this.transformPads = [new TransformPad(this.scene,{x:-2.7,y:.56,z:5.3},'wood'),new TransformPad(this.scene,{x:0,y:.56,z:3.9},'stone'),new TransformPad(this.scene,{x:2.7,y:.56,z:5.3},'paper')];
